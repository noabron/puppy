...
function doScreenshot() { 
    ...
    canvas.getContext('2d').drawImage(imageStickerPupy,(canvas.width-490), (canvas.height-370),(195),(165));
    canvas.getContext('2d').drawImage(imageStickerLogo,(canvas.width-660),( canvas.height-150),(255),(150));
