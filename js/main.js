...
function doScreenshot() { 
    ...
    canvas.getContext('2d').drawImage(imageStickerPupy,95,90,(imageStickerPupy.width*1.5),(imageStickerPupy.height*1.5));

    canvas.getContext('2d').drawImage(imageStickerLogo,-35,310,(imageStickerLogo.width*1.4),(imageStickerLogo.height*1.4));
